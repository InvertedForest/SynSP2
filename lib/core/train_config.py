...
# CUDNN config
cfg.CUDNN = CN(new_allowed=True)  # cudnn config
...
cfg.DATASET.ROOT_MOCAP_NOISE_3D=[2,3]
cfg.DATASET.ROOT_H36M_PPT_3D=[0]
cfg.DATASET.ROOT_H36M_FCN_3D=[0]
cfg.DATASET.ROOT_NH36M_NOISE_3D=[0]
...
cfg.MODEL.SLIDE_WINDOW_SIZE = 8  # slide window size
...
# test config
cfg.EVALUATE = CN(new_allowed=True)
...
def parse_args():
    ...
    if cfg.MODEL.SLIDE_WINDOW_SIZE is None:
